...
var _Calculate = __webpack_require__(34);
...
var Calculator = function (_Component) {
	...
	function Calculator(props) {
		...
		_this.handleClick = function (buttonValue) {
			_this.setState((0, _Calculate2.default)(_this.state, buttonValue));
		};
	...
	_createClass(Calculator, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(_Result2.default, { value: this.state.total || "0" }),
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: 'Row' },
					_react2.default.createElement(_Button2.default, { value: 'CE', clickHandler: this.handleClick }),
...
var _Operation = __webpack_require__(36);
	...
	if ((0, _isNumber2.default)(value) || value == ".") {
		...
		if (!state.next || number2 == "") {
			...
			if (op && state.next) {
				...
				var result = (0, _Operation2.default)(number1, number2, op);
				if (op == "CE" || op == "C") {
					//Reset
					number1 = "";
					number2 = "";
